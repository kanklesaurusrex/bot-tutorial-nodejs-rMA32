...
function respond() {
  var request = JSON.parse(this.req.chunks[0]),
      botRegex = /^\/cool guy/; botRegexsloth = /^\/sloth/; botRegexthx = /^\/thanksjeeves/; botRegexDL = /^\/DDL/i;botRegexRules = /^\/rules/
      botRegexP = /^\/PDL/i;  botRegexTw = /^\/twitch/i; botRegexSlut = /^\/slut/; botRegexStop = /^\/stop/; botRegexSch = /^\/Schedule/i; botRegexweekly = /^\/Schedule/;
  ...
  if(request.text && botRegex.test(request.text)) {
    ...
    else if(request.text && botRegexweekly.test(request.text)) {
    this.res.writeHead(200);
